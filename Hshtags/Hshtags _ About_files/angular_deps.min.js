...
var API_URL = '//api.hshtags.com/v1';// '//local.hshtagsapi.com/v1'; // local: /local.hshtagsapi.com/v1 ... prod:  //api.hshtags.com/v1
  ...
  var luser_service = {
    ...
    init: function(){
      ...
      if (luser_service.lstatus === 'logged-in' && luser_service.luid !== '') {
        ...
        // return null
        // $http.get('//api.hshtags.com/v1/users/'+luser_service.luid).success(function(data){
        //$http.defaults.headers.common.Authorization = 'Basic 2e97eedd908e31870ab4ea2795eb8827';
